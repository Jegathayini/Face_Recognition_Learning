...
# ============================================================
# PATHS (adjusted to your project structure)
# ============================================================

BASE_DIR = Path(__file__).parent.resolve()          # Exercises/Day_6
PROJECT_ROOT = BASE_DIR.parent.parent               # FaceRecognition_Learning
...
def load_or_build_database():
    ...
    print("Building embeddings database (first run)...")
    database = {}
...
# ============================================================
# ATTENDANCE (CSV version – matches your existing file)
# ============================================================
...
def main():
    known_database = load_or_build_database()
